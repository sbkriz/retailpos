...
> **Location**: All specs live under `docs/specs/[feature]/[spec-name].md`  
> **ADRs**: Architecture decisions live under `docs/adr/ADR-NNN-title.md`
...
| Platform Capabilities           | `docs/specs/platform/platform-capabilities.md` | Basket mode branching, capability matrix, UI gating, sellable-unit snapshot   |
